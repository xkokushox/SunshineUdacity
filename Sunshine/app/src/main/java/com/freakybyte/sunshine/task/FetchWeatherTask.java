package com.freakybyte.sunshine.task;
...
import com.freakybyte.sunshine.BuildConfig;
import com.freakybyte.sunshine.R;
import com.freakybyte.sunshine.data.LocationDao;
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, mContext.getString(R.string.api))
                    .build();
